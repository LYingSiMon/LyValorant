...
#define VM_BEGIN3()
#define VM_END()
#define VM_STRA(str) str
#define VM_STRW(str) str
#else
#define VM_STRA(str) VMProtectDecryptStringA(str)
#define VM_STRW(str) VMProtectDecryptStringW(str)
#define VM_BEGIN1() VMProtectBeginVirtualization(__FUNCTION__)
#define VM_BEGIN2() VMProtectBeginMutation(__FUNCTION__)
#define VM_BEGIN3() VMProtectBeginUltra(__FUNCTION__)
